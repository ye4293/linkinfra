...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/newsletter/status", middleware.AdminAuth(), controller.GetNewsletterStatus)
		apiRouter.POST("/newsletter/sync", middleware.AdminAuth(), middleware.CriticalRateLimit(), controller.RetryNewsletterSync)
		apiRouter.POST("/newsletter/config", middleware.RootAuth(), middleware.CriticalRateLimit(), controller.ConfigureNewsletter)
		...
		apiRouter.GET("/model-plaza/metrics/timeseries", controller.GetModelMetricsTimeSeries)
		apiRouter.POST("/stripe/webhook", middleware.GlobalWebRateLimit(), controller.StripeWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/models", controller.ListAvailableModels)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/clear_quota/:id", controller.ClearChannelQuota)
	...
	dashboardRoute.GET("/usage-metrics", middleware.AdminAuth(), controller.GetAdminUsageMetrics)
	...
	dashboardRoute.GET("/usage-metrics/self", middleware.UserAuth(), controller.GetUserUsageMetrics)
